...
const GalleyLabel: FC<LabelProps> = ({ preparation, flight }) => {
  ...
  return (
    <div className="border-2 border-black text-black bg-bg-surface font-sans w-full max-w-60 md:max-w-[340px]">
      {/* Header */}
      <div className="flex items-center justify-between border-b-2 border-black px-2 py-2">
        ...
        <div className="flex flex-col items-start w-16 md:w-20">
          <img
            ...
            className="h-6 xl:h-8 object-contain mb-2"
          />
          <div className="bg-black text-white px-1 md:px-2 xl:py-1 text-base md:text-base xl:text-lg font-bold w-full text-center">
            {flight.flightNumber}
          </div>
        </div>
        ...
        <div className="flex-1 flex justify-center">
          <QRCodeSVG value={qrData} className="size-[60px] xs:size-18 md:size-20 xl:size-24" />
        </div>
        ...
        <div className="flex flex-col items-end w-16 md:w-20">
          ...
          <div className="bg-black text-white px-1 xl:px-2 xl:py-1 text-base xl:text-lg font-bold w-full text-center">
            {preparation.stowage}
          </div>
        </div>
      </div>
      ...
      {/* Flight Info */}
      <div className="border-b-2 border-black px-2 py-1 text-center text-[9px]">
      ...
      <div className="px-4 py-6 md:py-8 text-center">
        <div className="font-bold text-2xl md:text-2xl leading-tight">
          {preparation.carrier}
        </div>
      </div>
    </div>
