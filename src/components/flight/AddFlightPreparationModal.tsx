    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          ...
          {/* Flight Info Grid */}
          <div className="w-full border border-gray-100 rounded-3xl overflow-hidden text-sm bg-white">
            <div className="grid grid-cols-2 divide-x divide-gray-100 divide-y font-rubik">
              <div className="grid grid-cols-2 p-4">
                <span className="text-gray-500">Aircraft</span>
                <span className="font-regular text-gray-800 text-base">
                  TS296
                </span>
              </div>
              <div className="grid grid-cols-2 p-4">
        ...
        <div className="flex justify-end gap-3 pt-6 border-t border-gray-200 mt-4">
          <button
            className="px-6 py-2 text-gray-700 text-sm font-medium border border-gray-300 rounded-lg hover:bg-gray-50 transition"
            onClick={onClose}
          >
            Cancel
          </button>
