...
const FlightLabels = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-secondary p-4 sm:p-6 md:p-8">
      {/* Tab Buttons */}
      <div className="flex mb-4">
        <button
          ...
          className={`flex-1 sm:flex-none px-4 sm:px-6 py-2 rounded-l-lg font-medium text-sm transition-colors duration-200 ${
            activeTab === "LABELS"
              ? "bg-border-accent text-text-primary shadow-md"
              : "bg-bg-secondary text-text-secondary hover:bg-border-muted"
          }`}
        >
          LABELS
        </button>
      ...
      {activeTab === "LABELS" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="bg-bg-surface rounded-lg shadow-md p-4 sm:p-6">
            <h3 className="text-base font-semibold text-text-primary mb-4 border-b border-border-muted pb-2">
            ...
            <div className="space-y-4">
              {outboundPreparations.map((prep, index) => (
                <div
                  key={index}
                  className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 border border-border-muted rounded-md transition-shadow hover:shadow-sm bg-bg-surface"
                >
      ...
      {activeTab === "REPORTS" && (
        <div className="bg-bg-surface rounded-lg shadow-md p-6 sm:p-8 text-center">
