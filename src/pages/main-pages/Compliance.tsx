    ...
    <div className="p-6 font-rubik md:p-8 bg-gray-50">
      <div className="flex flex-col md:flex-row justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-2 mt-4 md:mt-0">
          ...
          <button className="px-4 py-2 rounded-lg border border-border-muted bg-white text-gray-600 hover:bg-gray-100 transition-colors flex items-center gap-2 text-sm">
            <img src={RefreshIcon} />
          </button>
          <div
            className="relative"
          ...
          >
            <button
              ...
              className="px-4 py-2 rounded-lg border border-border-muted bg-white text-gray-600 hover:bg-gray-100 transition-colors flex items-center gap-2 text-sm"
            >
              Status
            ...
            <div
              className={`absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl z-10 border border-border-muted transition-all duration-200 origin-top ${
                openDropdown === "status"
